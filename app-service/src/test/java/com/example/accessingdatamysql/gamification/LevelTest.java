...
public class LevelTest {
    ...
    void fromPoints_shouldReturnCorrectLevel() {
        ...
        assertEquals(Level.LEVEL_1, Level.fromPoints(299));
        assertEquals(Level.LEVEL_2, Level.fromPoints(300));
        assertEquals(Level.LEVEL_3, Level.fromPoints(1000));
        assertEquals(Level.LEVEL_4, Level.fromPoints(2000));
    }
}
